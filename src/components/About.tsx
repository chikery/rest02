export default function About() {
  return (
    <section id="about" className="py-24 bg-white dark:bg-slate-800 transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                { color: 'bg-brand', text: '검증된 창업 방법론 기반' },
                ...
                <div key={v.text} className="flex items-center gap-3">
                  ...
                  <span className="text-slate-700 dark:text-slate-300 font-medium">{v.text}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          {/* Right */}
          <div className="space-y-4">
            {/* Company card — always dark for visual contrast */}
            <div className="bg-hero rounded-2xl p-8 text-white transition-colors">
              <p className="text-white/50 text-sm mb-2">회사 정보</p>
              <p className="text-2xl font-bold mb-1">RoadmapAI</p>
              <p className="text-brand-light text-sm mb-6">AI 사업 로드맵 코칭 스타트업</p>
            ...
            {/* Mission */}
            <div className="border-2 border-dark-green/30 dark:border-dark-green/40 bg-dark-green/5 dark:bg-dark-green/10 rounded-2xl p-6">
